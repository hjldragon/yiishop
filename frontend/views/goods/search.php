    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            ...
            <ul>
                <li>
                    <dl>
                        <dt><a href="/goods/goods.html?id=<?=$good->id?>"><?=Html::img(Yii::$app->params['imageDomain'].$good->logo)?></a></dt>
                        <dd><?=Html::a($good->name,['goods/goods','id'=>$good->id])?></dt>
                        <dd><strong><?=$good->market_price?></strong></dt>
                        <dd><a href="/goods/goods.html?id=<?=$good->id?>"><em>已有10人评价</em></a></dt>
                    </dl>
                </li>
            </ul>
            <?php endforeach;?>
