...
<head>
    ...
    <!--引用百度地图API-->
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=L4HEIuPGM0aTIjXRFkU4bcdpA351GxYa"></script>
</head>
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        map.centerAndZoom(new BMap.Point(114.006261,22.595674),18);
    }
