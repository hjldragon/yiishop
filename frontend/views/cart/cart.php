...
?>
    ...
    <div class="mycart w990 mt10 bc">
        ...
        <table>
            ...
            <?php foreach ($models as $model):?>
                <tr data-goods_id="<?=$model['id']?>">
                    <td class="col1"><a href=""><?=Html::img(Yii::$app->params['imageDomain'].$model['logo'])?></a>
        ...
        <div class="cart_btn w990 bc mt10">
            <a href="/goodscategory/index.html" class="continue">继续购物</a>
            <?php
                if(Yii::$app->user->isGuest){
                   echo '<a href="/user/login.html" class="checkout">请登录后再结算</a>';
                }else{
                   echo '<a href="/cart/order.html" class="checkout">结 算</a>';
                }
            ?>
...
$this->registerJs(new \yii\web\JsExpression(
    ...
    var sum=$('#total').text();
    //删除要删除行的价格
    var del_one=$(this).closest('tr').find('.col5 span').text();
    //新的总价
    sum =sum-del_one;
    $('#total').html(sum);
    //console.debug(del_one);exit;
