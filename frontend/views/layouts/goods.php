...
<!--        </script>-->
        ...
        <div class="topnav_bd w990 bc">
            ...
            <div class="topnav_right fr">
                ...
                ";
                            ...
                            echo '用户'.''.Yii::$app->user->identity->username.''.'您好，欢迎来到京西！';
                            echo Html::a('注销',['user/logout']);
                        }
                        ?>
                    </li>
                    <li class="line">|</li>
    ...
    <div class="header w1210 bc mt15">
        ...
        <div class="logo w1210">
            <h1 class="fl"><a href="/goodscategory/index.html"><?=Html::img('@web/images/logo.png');?></a></h1>
            <!-- 头部搜索 start -->
            <div class="search fl">
                ...
                <dl>
                    ...
                    <dd>
                        <div class="prompt">
                            <?php
                            if(Yii::$app->user->isGuest){
                                echo '您好，请<a href="/user/login.html">登录</a>';
                            }else{
                                echo '用户'.''.Yii::$app->user->identity->username.''.'您好';
                                echo'</div>
                        <div class="uclist mt10">
                            <ul class="list1 fl">
                                <li><a href="">用户信息</a></li>
                                <li><a href="cart/myorder.html">我的订单</a></li>
                                <li>'.Html::a('收货地址',\yii\helpers\Url::to(['user/address'])).'</li>
                                <li><a href="">我的收藏</a></li>
                            </ul>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="navitems fl">
            <ul class="fl">
                <li class="current"><a href="/goodscategory/index.html">首页</a></li>
                <li><a href="">电脑频道</a></li>
                <li><a href="">家用电器</a></li>
                <li><a href="">品牌大全</a></li>
                <li><a href="">团购</a></li>
